...
Abra http://127.0.0.1:8080/home.html. Marque o aceite LGPD demonstrativo, conclua o cadastro e explore oportunidades. `home.html` e `oportunidades.html` carregam `integration/tracking.js`, sem ler campos de formulário, CNPJ, e-mail ou busca. Para teste técnico isolado, use também http://127.0.0.1:8080/demo.html.
